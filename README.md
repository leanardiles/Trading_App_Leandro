...
- **Bot Management** - Create, monitor, pause, and manage multiple trading bots
...
**Example:**
```bash
# Test MEDIUM risk strategy with $1000 for 1 week
python manage.py backtest_hermes --risk-level MEDIUM --investment 1000
...
See [Backtest Documentation](backend_django/trading_back/BACKTEST_README.md) for detailed guide.
...
- Click "Create Bot"
- Bot will start trading automatically using ML strategies
...
- **Hermes Bot** page - Monitor bot performance, ROI, win rate
...
│       │   ├── urls.py                # API routing
│       │   ├── herm_trades.py         # Hermes bot API [NEW]
│       │   ├── auto_trading_engine.py # Trading engine [NEW]
│       │   ├── backtest_hermes_bot.py # Backtesting system [NEW]
...
│       │   └── management/commands/
│       │       └── backtest_hermes.py # Backtest CLI [NEW]
│       ├── manage.py
│       └── db.sqlite3
├── frontend_react/
│   ├── src/
│   │   ├── components/
│   │   │   └── Layout.jsx             # Main layout with logo
│   │   ├── pages/
│   │   │   ├── Dashboard.jsx          # Portfolio overview
│   │   │   ├── Trading.jsx            # Manual trading
│   │   │   ├── HermesAgent.jsx        # Bot management [NEW]
...
- Automated trading with multi-strategy ML integration
- Three risk profiles (LOW/MEDIUM/HIGH)
- Backtesting system for historical simulation
- Bot management dashboard
- Performance tracking (ROI, win rate, trades)

### December 14, 2025:
✅ **Trading Signals System** - Index addition alerts with notifications
✅ **Realized P/L Tracking** - Separate tracking for closed positions
✅ **Dashboard Redesign** - 4 comprehensive metrics
✅ **UI Improvements** - Better icons, Hermes branding

### December 12-13, 2025:
✅ **Real-Time Prices** - Yahoo Finance integration
✅ **Interactive Charts** - Historical price visualization
✅ **Auto-Refresh** - Holdings update every 30s
✅ **Performance Tracking** - Historical snapshots and charts
...
Signal.objects.create(
    ...
    description='Tesla added to major index...',
...
- **API Documentation**: [API_ENDPOINTS.md](backend_django/trading_back/API_ENDPOINTS.md)
- **Backtest Guide**: [BACKTEST_README.md](backend_django/trading_back/BACKTEST_README.md)
